      ...
      <div className="relative flex flex-col h-[65%] md:h-full flex-grow bg-white">
        <div className="flex-1 overflow-y-auto pt-3 px-4 md:p-6">
          <div className="pb-16 md:pb-20">
            ...
            {/* BODY: Fully justified and size fixed */}
        ...
        {/* 3. SHARE SECTION: WhatsApp Icon Only */}
        <div className="absolute bottom-4 right-4 pointer-events-none">
            <button 
              onClick={handleShare}
              className="pointer-events-auto flex items-center justify-center bg-white shadow-md border border-gray-100 w-12 h-12 rounded-full active:scale-90 transition-transform"
