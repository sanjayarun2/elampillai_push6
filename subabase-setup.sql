...
-- Drop and recreate push_subscriptions table with enhanced tracking
...
CREATE INDEX IF NOT EXISTS notification_logs_subscription_id_idx ON notification_logs(subscription_id);
